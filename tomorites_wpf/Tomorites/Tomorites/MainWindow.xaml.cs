...
namespace Tomorites
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void tomoritendoSzovegTallozasBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            szoveg_tallozasa_dlg.Filter = "html|*.html|css|*.css|text file|*.txt|javascript|*.js";
            ...
            if (result == true)
            {
                ...
                bekert_szoveg_nev = szoveg_tallozasa_dlg.SafeFileName.Replace('.', '_');

                List<string> bekert_szoveg = new List<string>();

                StreamReader szoveg_sr = new StreamReader(bekert_szoveg_eleresi_ut);
                ...
                StreamWriter kulcs_mentese_sw = new StreamWriter(kulcs_mentese_savedlg.FileName);
                ...
                StreamWriter tomoritett_szoveg_sw = new StreamWriter(szoveg_mentese_savedlg.FileName);
